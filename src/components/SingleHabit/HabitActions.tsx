  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="bg-popover text-popover-foreground">
        <DropdownMenuItem onSelect={onEdit} className="text-foreground transition-colors duration-300">
          <Edit2 className="w-4 h-4 mr-2 text-muted-foreground transition-colors duration-300" />
          Edit
        </DropdownMenuItem>
        <DropdownMenuItem onSelect={handleDeleteClick} className="text-foreground transition-colors duration-300">
